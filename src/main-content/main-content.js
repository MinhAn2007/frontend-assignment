...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const imageScrollItems = document.querySelectorAll(
    ".section-image-scroll img"
  );
  ...
  const contentData = [
    ...
    {
      id: 2,
      title: "Super-efficient solar cells",
      content:
        "A new approach to cancer treatment is using vaccines made from patients own cells.",
    },
    {
      id: 3,
      title: "Apple Vision Pro",
      content:
        "A startup is developing a contact lens with a built-in display.",
    },
    {
      id: 4,
      title: "Weight-loss drugs",
      content: "Machine learning is speeding up the search for new drugs.",
    },
    {
      id: 5,
      title: "Enhanced geothermal systems",
      content:
        "A new chip design could make it easier to build quantum computers.",
    },
  ];
    ...
    imageWrapper.addEventListener("scroll", function () {
      ...
      imageScrollItems.forEach((image, index) => {
        ...
        if (
          ...
          imageRect.top <= wrapperRect.bottom
        ) {
          currentIndex = index;
        }
      });
